...
def main():
    ...
    print("=" * 60)
    print("🗳️  BALLOT Face Verification Test")
    print("=" * 60)
    ...
    print("\n⏳ Loading face verification module...")
    start = time.time()
    from face_verification import verify_face_match
    load_time = time.time() - start
    print(f"✅ Module loaded in {load_time:.2f}s")
    ...
    if result['verified']:
        print("✅ VERIFIED - Faces match!")
    else:
        print("❌ REJECTED - Faces do not match")
    ...
    print(f"\n⏱️  Verification time: {verify_time:.2f}s")
    print("=" * 60)
